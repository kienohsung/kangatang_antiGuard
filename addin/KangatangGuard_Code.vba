...
' Phien ban: v3.5.0 (Real-Time Directory Streaming Architecture)
...
Public Function MsgBoxW(ByVal prompt As String, Optional ByVal buttons As VbMsgBoxStyle = vbOKOnly, Optional ByVal title As String = "") As VbMsgBoxResult
    ...
    If Len(title) = 0 Then
        title = Uni("KangatangGuard v3.5.0")
    End If
...
Public Sub InitializeGuard()
    ...
    WriteLog "KangatangGuard v3.5.0 da khoi dong thanh cong."
...
Private Sub CreateMenu()
    ...
    btn4.Caption = Uni("Th\u00f4ng tin KangatangGuard v3.5.0")
    btn4.FaceId = 487
    ...
    If virusFound Then
        ...
        If wb.ReadOnly Then
            ...
            MsgBoxW Uni("C\u1ea2NH B\u00c1O: PH\u00c1T HI\u1ec6N VIRUS KANGATANG TRONG T\u1ec6P CH\u1ec8 \u0110\u1eccC (READ-ONLY)!" & vbCrLf & vbCrLf & _
                    ...
                    vbCritical, Uni("KangatangGuard v3.5.0 - C\u1ea3nh b\u00e1o")
            Exit Sub
        End If
        ...
        If backupOK Then
            ...
            If cleanResult Then
                ...
                MsgBoxW Uni("C\u1ea2NH B\u00c1O: PH\u00c1T HI\u1ec6N VIRUS KANGATANG!" & vbCrLf & vbCrLf & _
                        ...
                        vbExclamation, Uni("KangatangGuard v3.5.0 - Th\u00e0nh c\u00f4ng")
                
                ' v3.5.0: Khoi chay tien trinh quet ngam doc lap (khong lam treo Excel)
            ...
            Else
                ...
                MsgBoxW Uni("C\u1ea2NH B\u00c1O: Ph\u00e1t hi\u1ec7n virus nh\u01b0ng KH\u00d4NG TH\u1ec2 l\u00e0m s\u1ea1ch t\u1ef1 \u0111\u1ed9ng!" & vbCrLf & _
                        ...
                        vbCritical, Uni("KangatangGuard v3.5.0 - L\u1ed7i")
            End If
        Else
            ...
            MsgBoxW Uni("C\u1ea2NH B\u00c1O: Ph\u00e1t hi\u1ec7n virus nh\u01b0ng KH\u00d4NG TH\u1ec2 t\u1ea1o b\u1ea3n sao l\u01b0u (Backup)!" & vbCrLf & _
                    ...
                    vbCritical, Uni("KangatangGuard v3.5.0 - C\u1ea3nh b\u00e1o an to\u00e0n")
        End If
    Else
...
' ===========================================================================
' HAM KHOI CHAY TIEN TRINH QUET NGAM DOC LAP (v3.5.0 - ASYNCHRONOUS WORKER)
...
' ===========================================================================
' HAM BACKUP: Tao ban sao file truoc khi lam sach (v3.5.0)
...
Public Sub ScanActiveWorkbook()
    If ActiveWorkbook Is Nothing Then
        MsgBoxW Uni("Kh\u00f4ng c\u00f3 t\u1ec7p Excel n\u00e0o \u0111ang m\u1edf."), vbInformation, Uni("KangatangGuard v3.5.0")
        Exit Sub
    End If
    ...
    MsgBoxW Uni("\u0110\u00e3 ho\u00e0n th\u00e0nh qu\u00e9t t\u1ec7p: ") & wbName & vbCrLf & _
            ...
            vbInformation, Uni("KangatangGuard v3.5.0")
End Sub

' ===========================================================================
' HAM MENU: Quet thu muc (goi tu menu, hien hop thoai chon thu muc)
' v3.5.0: Tach tien trinh quet ngam doc lap khong lam treo Excel
' ===========================================================================
Public Sub ScanFolderDialog()
    ...
    If fd.Show = -1 Then
        ...
        ' v3.5.0: Goi worker ngam doc lap (non-blocking)
        ...
        MsgBoxW Uni("\u0110\u00e3 kh\u1edfi ch\u1ea1y ti\u1ebfn tr\u00ecnh qu\u00e9t ng\u1ea7m \u0111\u1ed9c l\u1eadp cho th\u01b0 m\u1ee5c:" & vbCrLf & vbCrLf) & _
                ...
                vbInformation, Uni("KangatangGuard v3.5.0 - Ti\u1ebfn tr\u00ecnh ng\u1ea7m")
    End If
End Sub
...
Public Sub ShowAbout()
    MsgBoxW Uni("KangatangGuard v3.5.0" & vbCrLf & vbCrLf & _
                ...
                "Phi\u00ean b\u1ea3n ki\u1ebfn tr\u00fac: v3.5.0 Production-grade"), _
            vbInformation, Uni("Gi\u1edbi thi\u1ec7u KangatangGuard v3.5.0")
End Sub
