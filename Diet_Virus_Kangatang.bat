...
setlocal
chcp 65001 >nul
title HỆ THỐNG DIỆT VIRUS EXCEL KANGATANG - EXCEL CLEANER v3.5.0
...
Write-Host "   HỆ THỐNG DIỆT VIRUS MACRO KANGATANG - EXCEL CLEANER (v3.5.0)       " -ForegroundColor Cyan
